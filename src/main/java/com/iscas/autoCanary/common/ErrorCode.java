...
public enum ErrorCode {
    ...
    DEPLOYMENT_CONFIG_ERROR(31000,"Deployment配置文件错误",""),
    TASK_NOT_FOUND(32000,"Task不存在",""),
    RESUME_FLOW_ERR(32001,"恢复流量失败",""),
    TASK_LOG_NULL(32002,"Task的log日志为空",""),
    TEST_ERR(32003,"点火测试失败",""),
