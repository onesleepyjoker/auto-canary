...
-- 创建库
create
    database if not exists auto_canary;
...
(
    ...
    imageStatus  int      default 0                 not null comment '状态 0 - 正常',
...
#
# 导入示例用户
INSERT INTO user (username, userAccount, avatarUrl, gender, userPassword, phone, email, imageStatus, createTime,
                  updateTime, isDelete, userRole, planetCode)
VALUES ('user1', 'auto_canary', 'https://himg.bdimg.com/sys/portraitn/item/public.1.e137c1ac.yS1WqOXfSWEasOYJ2-0pvQ',
        null, 'b0dd3697a192885d7c055db46155b26a', null, null, 0, '2023-08-06 14:14:22', '2023-08-06 14:39:37', 0, 1,
        '1');
INSERT INTO user (username, userAccount, avatarUrl, gender, userPassword, phone, email, imageStatus,
